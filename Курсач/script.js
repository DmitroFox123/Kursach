...
function Month(){
    ...
    let Month;
    switch(month){
        case 0: if(month == 0) Month = "Января";
        case 1: if(month == 1) Month = "Февраля";
        case 2: if(month == 2) Month = "Марта";
        case 3: if(month == 3) Month = "Апреля";
        case 4: if(month == 4) Month = "Мая";
        case 5: if(month == 5) Month = "Июня";
        case 6: if(month == 6) Month = "Июля";
        case 7: if(month == 7) Month = "Августа";
        case 8: if(month == 8) Month = "Сентября";
        case 9: if(month == 9) Month = "Октября";
        case 10: if(month == 10) Month = "Ноября";
        case 11: if(month == 0) Month = "Декабря";
    }
    return Month;
}

let kettleDateKur = document.getElementsByClassName("dateKettle");

for(let i = 0; i < kettleDateKur.length; i++){
addEventListener("DOMContentLoaded", () => {
    let DayDeliery = date.getDate() + 7;
    kettleDateKur[i].innerHTML = DayDeliery + " " + Month();
})
}
